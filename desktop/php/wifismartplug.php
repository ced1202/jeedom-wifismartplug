...
<div class="row row-overflow">
        ...
        <div class="bs-sidebar">
            <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
                <a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;"
                   data-action="add"><i class="fa fa-plus-circle "></i> {{Ajouter un dispositif}}</a>
    ...
    <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay"
        ...
        <div class="eqLogicThumbnailContainer">
            ...
            <div class="cursor" id="bt_healthsmartplug"
                 style="background-color : #ffffff; height : 120px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;">
                <center>
        ...
        <div class="tab-content" style="height:calc(100% - 50px);overflow:auto;overflow-x: hidden;">
            <div role="tabpanel" class="tab-pane active" id="eqlogictab">
                <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" class="eqLogicAttr form-control" data-l1key="configuration"
                                               data-l2key="addr" placeholder="{{Adresse IP}}"/>
                                    </div>
                                </div>
                            </fieldset>
                    ...
                    <div class="col-sm-6">
                        <center>
                            <img src="plugins/wifismartplug/doc/images/HS100.jpg" id="img_mpowerModel"
                                 style="width : 500px;">
                        </center>
                    </div>
                </div>
